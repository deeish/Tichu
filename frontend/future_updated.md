...
Trick resolution – Winner highlight + cards to stack + short message before next trick.
Card backs for opponents – So their hands look like real hands.
Sound – Start with play / pass / trick-won and a mute toggle.
Polish – Delays, phase messages, no alerts, better card styling or images.